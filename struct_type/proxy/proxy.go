...
/*
代理模式是一种结构型设计模式，充当一个代理，控制某个对象的访问。代理模式基于目标对象（被代理对象）提供了一个代理对象，
客户端通过代理对象来访问目标对象，从而可以在目标对象的基础上增加额外的功能。
...
func (r *RealSubject) Request() {
	fmt.Println("RealSubject_Request")
}
...
func (p *Proxy) Request() {
	fmt.Println("Proxy: Pre_Request")
	if p.real_subject == nil {
		p.real_subject = &RealSubject{}
	}
	p.real_subject.Request()
	fmt.Println("Proxy: Post_Request")
}
